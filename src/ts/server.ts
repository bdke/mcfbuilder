import {
  ...
  let keywords = ['if','while','for','return','in','to','var','global','def','true','false','score','tag','else']
  let builtInFuntions = ["Write","LoadFile"];
